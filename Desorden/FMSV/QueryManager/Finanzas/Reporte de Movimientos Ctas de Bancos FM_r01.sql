...
-- Bank Transaction FMSV
exec fmsv.dbo.getBankAccounts

insert into #Result (AccountName) values ('--Filmisa El Salvador---')
...
while @@fetch_status = 0
	begin
		exec fmsv.dbo.ObtenerSaldoCuenta @StartDateGhost,@EndDateBalanceAccount,@cAccount,@nSaldo output
