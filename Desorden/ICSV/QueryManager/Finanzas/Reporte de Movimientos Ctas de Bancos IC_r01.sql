...
-- Bank Transaction ICSV
exec icsv.dbo.getBankAccounts

insert into #Result (AccountName) values ('--Imprecen El Salvador---')
...
while @@fetch_status = 0
	begin
		exec icsv.dbo.ObtenerSaldoCuenta @StartDateGhost,@EndDateBalanceAccount,@cAccount,@nSaldo output
