...
if (@nYear=year(@dFechaFin))
	begin
		...
		exec cvsv.dbo.ObtenerSaldoCuenta @dFechaIni,@dFechaFin,@cCuenta,@nSaldo output 
		...
		exec cvsv.dbo.ObtenerSaldoCuenta @dFechaIniAnual,@dFechaFinAnual,@cCuenta,@nSaldo output
