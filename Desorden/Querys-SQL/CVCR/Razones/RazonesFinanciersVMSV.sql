...
if (@nYear=year(@dFechaFin))
	begin
		...
		exec vmsv.dbo.ObtenerSaldoCuenta @dFechaIni,@dFechaFin,@cCuenta,@nSaldo output 
		...
		exec vmsv.dbo.ObtenerSaldoCuenta @dFechaIniAnual,@dFechaFinAnual,@cCuenta,@nSaldo output
