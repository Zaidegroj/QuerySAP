...
SELECT T3.GroupName AS Grupo,
 ...
 INNER JOIN cvhn.dbo.OCRD T2 ON T0.CardCode=T2.CardCode
 INNER JOIN cvhn.dbo.OCRG T3 ON T3.GroupCode=T2.GroupCode
 inner join cvhn.dbo.OCTG AS t4 ON T2.GroupNum = t4.GroupNum 
