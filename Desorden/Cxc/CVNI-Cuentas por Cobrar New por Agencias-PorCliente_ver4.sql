...
SELECT T3.GroupName AS Grupo,
 ...
 INNER JOIN cvni.dbo.OCRD T2 ON T0.CardCode=T2.CardCode
 INNER JOIN cvni.dbo.OCRG T3 ON T3.GroupCode=T2.GroupCode
 inner join cvni.dbo.OCTG AS t4 ON T2.GroupNum = t4.GroupNum 
