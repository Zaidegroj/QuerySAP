...
SELECT     T0.CardCode	AS Cliente, T0.CardName AS Nombre, T2.CntctPrsn AS agencia, T1.SeriesName AS Serie, T0.DocNum AS Documento,t4.ExtraMonth,t4.ExtraDays, t0.u_VttoAgencia,
						...
						case 
							...
							when T2.CntctPrsn not like '%DIRECTO%' then cvsv.dbo.ObtenerFechaFinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,t0.DocDate))) end AS Vence,
						...
						case 
							...
							when T2.CntctPrsn not like '%DIRECTO%' and DATEDIFF(DD, cvsv.dbo.ObtenerFechaFinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,T0.DocDate))),@Fecha) <= 0 then (T0.DocTotal - T0.PaidToDate) end as Normal,
						case 
							...
							when T2.CntctPrsn not like '%DIRECTO%' and DATEDIFF(DD,cvsv.dbo.ObtenerFechaFinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,T0.DocDate))), @Fecha) >= 1 AND DATEDIFF(DD,cvsv.dbo.ObtenerFechaFinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,T0.DocDate))), @Fecha) <= 30 THEN (T0.DocTotal - T0.PaidToDate) END AS M030,
						case 
							...
							when T2.CntctPrsn not like '%DIRECTO%' and DATEDIFF(DD, cvsv.dbo.ObtenerFechaFinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,T0.DocDate))), @Fecha) >= 31 AND DATEDIFF(DD, cvsv.dbo.ObtenerFechafinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,T0.DocDate))), @Fecha) <= 60 THEN (T0.DocTotal - T0.PaidToDate) END AS M060,
						case 
							...
							when T2.CntctPrsn not like '%DIRECTO%' and DATEDIFF(DD, cvsv.dbo.ObtenerFechaFinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,T0.DocDate))), @Fecha) >= 61 AND DATEDIFF(DD,cvsv.dbo.ObtenerFechaFinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,T0.DocDate))), @Fecha) <= 90 THEN (T0.DocTotal - T0.PaidToDate) END AS M090, 					
						case 
							...
							when T2.CntctPrsn not like '%DIRECTO%' and DATEDIFF(DD, cvsv.dbo.obtenerFechafinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,T0.DocDate))), @Fecha) >= 91 AND DATEDIFF(DD,cvsv.dbo.ObtenerFechaFinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,T0.DocDate))), @Fecha) <= 120 THEN (T0.DocTotal - T0.PaidToDate) END AS M120, 
						case 
							when T2.CntctPrsn like '%DIRECTO%' and DATEDIFF(DD, T0.DocDueDate,@Fecha) >= 121 THEN (T0.DocTotal - T0.PaidToDate) 
							when T2.CntctPrsn not like '%DIRECTO%' and DATEDIFF(DD, cvsv.dbo.ObtenerFechaFinal(dateadd(dd,t4.ExtraDays,dateadd(mm,t4.ExtraMonth,T0.DocDate))),@Fecha) >= 121 THEN (T0.DocTotal - T0.PaidToDate) END AS Mas,
