...
if (@iInDesign = 1)
	begin
		set @dFechaIni = '09/01/2011 00:00:00'
		set @dFechaFin = '09/30/2011 00:00:00'
	end
else
	begin
...
WHERE	T1.DocDate   >= @dFechaIni
		AND T1.DocDate   <= @dFechaFin
		AND T1.DocType    = 'S'
		AND T5.GroupCode <> '104' and t5.GroupCode <> 108
...
-- Devolución Clientes Theatrical
...
SELECT Grupo,
		Nombre,
		Bruto/@Tc as Brut0,
		Descuento/@Tc as Descuento,
		Neto/@Tc as Neto,
		Cantidad as Cantidad,
		PrecioPromedio/@Tc as PrecioPromedio,
		CostoTotal/@Tc as CostoTotal,
		CostoPromedio/@Tc as CostoPromedio
FROM #Tmp_Ven
