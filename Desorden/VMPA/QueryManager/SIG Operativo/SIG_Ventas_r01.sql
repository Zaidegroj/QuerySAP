...
if (@iInDesign = 1)
	begin
		set @dFechaIni = '02/01/2012 00:00:00'
		set @dFechaFin = '02/29/2012 00:00:00'
	end
else
	begin
...
/*
	...
	Habìa un problema al mostrar las ventas theatrical, se agrega un filtro (t5.GroupCode <> 107) para que se excluyan las que cumplen ese filtro.
