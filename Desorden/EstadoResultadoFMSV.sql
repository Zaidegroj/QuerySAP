...
if (@nInDesign = 1)
	begin
		...
		set @dFechaIniAcum	= '01/01/2011 00:00:00'
		set @nNivel			= 5
		--set @Tc				= 8
	end
else
...
exec prsv.dbo.EstadoResultadoxMeses 'PRSV',@dFechaIni,@dFechaFin,@dFechaIniAcum,@nNivel,@Tc

-- Formateo el Estado de Resultados en base a las cuentas correspondientes.

exec prsv.DBO.EstadoResulFormato @nNivel
--
