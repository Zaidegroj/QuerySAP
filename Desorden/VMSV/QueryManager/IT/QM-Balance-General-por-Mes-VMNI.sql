...
(
	...
	from (
		select b.AcctCode as AcctCode,b.AcctName,b.FatherNum,b.Segment_0,b.FormatCode from vmni.dbo.oact b where Levels=5
...
exec vmni.dbo.BalanceGeneral 'VMNI',@dFechaIni,@dFechaFin,@nNivel,2
